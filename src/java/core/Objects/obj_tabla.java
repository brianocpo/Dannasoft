    ...
    public String getTablaHtml() {
        ...
        for (int i = 0; i < this.lista_gridRow.size(); i++) {
            ...
            for (int j = 0; j < this.lista_gridRow.get(i).getLista_gridColumn().size(); j++) {
                ...
                htmlTablaBodyTD += "<td scope=\"col\"   width=\"" + ls_width + "\" id=\"col" + this.ls_ordenTB + "_" + i + "_" + j + "\" onclick=\"getColumn(" + i + "," + j + ",'" + ls_nombreColumn + "','" + ls_codigo_fk_select + "',false,'" + this.ls_nombre_colPK + "','" + this.ls_Id_Tabla + "',jsonRows" + ls_ordenTB + ",jsonColumns" + ls_ordenTB + ",'" + this.ls_name_tabla + "','" + this.ls_ordenTB + "')\">" + ls_valor_column + "</td>";
