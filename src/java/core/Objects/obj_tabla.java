...
public class obj_tabla implements Serializable {
    ...
    public String getTablaHtml() {
        ...
        for (int i = 0; i < this.lista_gridRow.size(); i++) {          
            ...
            htmlTablaCheckElim="<td scope='col'   width='5px' id='colE_elim" + this.ls_ordenTB + "_" + i + "' onclick=\"getColumnAction('"+ls_ordenTB+"',"+ls_IdRow+")\"><input type='checkbox' name='check[]' class='checkEliminar"+ls_ordenTB+"' value='"+ls_IdRow+"' onchange=\" verificarCambiosControles('"+ls_ordenTB+"','"+ls_IdRow+"');checkTrueFilaTabla('"+ls_name_tabla+"', '" + this.ls_nombre_colPK + "', '"+ls_ordenTB+"', '"+ls_IdRow+"',this,'" + ls_classRow + "')\"></td>";
