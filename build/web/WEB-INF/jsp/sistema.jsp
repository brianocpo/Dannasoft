            ...
            <div class="navbar-container ace-save-state" id="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="login" class="navbar-brand">
                        <small>
                            <img style="height:20px" src="${pageContext.request.contextPath}/resources/images/logo.png"  class="img-circle" />   								
                            Dannsoft
                        </small>
                    </a>
                </div>
                    ...
                    <ul class="nav ace-nav">
                                    ...
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a href="#" class="clearfix">
                                                <img src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
                                                <span class="msg-body">
                                        ...
                                        <li>
                                            <a href="#" class="clearfix">
                                                <img src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
                                                <span class="msg-body">
                                                    <span class="msg-title">
                                        ...
                                        <li>
                                            <a href="#" class="clearfix">
                                                <img src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
                                                <span class="msg-body">
                                                    <span class="msg-title">
                                        ...
                                        <li>
                                            <a href="#" class="clearfix">
                                                <img src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
                                                <span class="msg-body">
                                                    <span class="msg-title">
                                        ...
                                        <li>
                                            <a href="#" class="clearfix">
                                                <img src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
                                                <span class="msg-body">
                                                    <span class="msg-title">
                        ...
                        <li class="light-blue dropdown-modal">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="${pageContext.request.contextPath}/resources/assets/images/avatars/user.jpg" alt="Jason's Photo" />
                                                        ...
                                                        <div id="member-tab" class="tab-pane">
                                                            <div class="clearfix">
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Bob Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/user.jpg" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Joe Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar2.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Jim Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Alex Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar5.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Bob Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar2.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Susan's avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar3.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Phil Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar4.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv memberdiv">
                                                                    <div class="user">
                                                                        <img alt="Alexa Doe's avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar1.png" />
                                                                    </div>
                                                        ...
                                                        <div id="comment-tab" class="tab-pane">
                                                            <div class="comments">
                                                                <div class="itemdiv commentdiv">
                                                                    <div class="user">
                                                                        <img alt="Bob Doe's Avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv commentdiv">
                                                                    <div class="user">
                                                                        <img alt="Jennifer's Avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar1.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv commentdiv">
                                                                    <div class="user">
                                                                        <img alt="Joe's Avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar2.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv commentdiv">
                                                                    <div class="user">
                                                                        <img alt="Rita's Avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar3.png" />
                                                                    </div>
                                                ...
                                                <div class="widget-main no-padding">
                                                    <div class="dialogs">
                                                        <div class="itemdiv dialogdiv">
                                                            <div class="user">
                                                                <img alt="Alexa's Avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar1.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv dialogdiv">
                                                            <div class="user">
                                                                <img alt="John's Avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar.png" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv dialogdiv">
                                                            <div class="user">
                                                                <img alt="Bob's Avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/user.jpg" />
                                                            </div>
                                                        ...
                                                        <div class="itemdiv dialogdiv">
                                                            <div class="user">
                                                                <img alt="Jim's Avatar" src="${pageContext.request.contextPath}/resources/assets/images/avatars/avatar4.png" />
                                                            </div>
